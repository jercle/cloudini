...
import (
	...
	"dev.azure.com/APCDevOps/cloudini/lib"
...
func main() {
	...
	// os.Exit(0)
	cldConfig.SophosConfig = generateSophosConfig(envs)
	cldConfig.Azure = generateAzureConfig(envs)
	cldConfig.CitrixCloud = generateCitrixCloudConfig(envs)
