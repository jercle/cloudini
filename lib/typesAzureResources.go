...
type AzureResourceDetails struct {
	...
	CitrixVmDeliveryGroup     string                          `json:"citrixVmDeliveryGroup,omitempty" bson:"citrixVmDeliveryGroup,omitempty" fake:"-"`
	AssociatedVM              string                          `json:"AssociatedVM,omitempty" bson:"AssociatedVM,omitempty" fake:"-"`
}
