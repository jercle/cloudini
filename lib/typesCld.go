...
type ForgerockConfig struct {
	...
	GroupOUs       []string  `json:"groupOUs"`
	GroupOUsTenant string    `json:"groupOUsTenant"`
	GroupOUsPrefix *string   `json:"groupOUsPrefix"`
}
...
type MongoDBConfig struct {
	...
	CollCitrixMonitorMachines          string `json:"collCitrixMonitorMachines,omitempty"`
	CollCitrixMonitorMetrics           string `json:"collCitrixMonitorMetrics,omitempty"`
	CollCitrixMonitorResUtil           string `json:"collCitrixMonitorResUtil,omitempty"`
	CollCitrixMonitorLoadIndexes       string `json:"collCitrixMonitorLoadIndexes,omitempty"`
