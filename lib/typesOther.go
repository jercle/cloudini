...
type CertAuthorityCertInfo struct {
	...
	RelatedServersCertUsedOn       []string   `json:"relatedServersCertUsedOn,omitempty" bson:"relatedServersCertUsedOn,omitempty"`
...
type ServerCertInfo struct {
	...
	ServersPulledFrom        []string               `json:"serversPulledFrom,omitempty" bson:"serversPulledFrom,omitempty"`
	TenantName               string                 `json:"tenantName,omitempty" bson:"tenantName,omitempty"`
