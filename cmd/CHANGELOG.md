...
## [0.3.62]
* Change Azure Alerts to include extra props

## [0.3.61]
* Add Key Vault secret uploads (Names only, no actual secrets. Used for searching across multiple KVs)

## [0.3.60]
* Fixes to citrix data uploads
...
## [0.3.56]
* Update cost data processing to include Citrix Del Grps if exist

## [0.3.55]
* Add mongo update FR AD Groups

## [0.3.54]
* Further optimizing UpdateResourcesNotExistInAzure

## [0.3.53]
* Optimize UpdateResourcesNotExistInAzure to use collection.UpdateMany instead of a find, modify, then udpate.
