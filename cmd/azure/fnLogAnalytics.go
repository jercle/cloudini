...
func GetAzureWorkbookAlerts(graphQuery string, token *lib.AzureMultiAuthToken, getAlertLogData bool) (alerts []AzureAlertProcessed) {
	...
	for _, alert := range alertsResponse.Data {
		...
		if alert.Properties.Context.Context != nil {
			...
			// fmt.Println("inside if alert.Properties.Context.Context != nil {")
			// fmt.Println(curr.LinkToFilteredSearchResultsAPI)
			// fmt.Println(curr.LinkToFilteredSearchResultsUi)
			if getAlertLogData {
