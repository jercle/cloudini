...
var cmdMongoUpdate = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		if updateAll || updateFrADGroups {
			wg.Go(func() {
				UpdateFrADGroups(entraFrGroupsColl)
			})
		}
		...
		if updateKeyVaultSecrets {
			wg.Go(func() {
				UpdateKeyVaultSecrets(azKeyVaultSecretsColl)
			})
		}
...
func init() {
	...
	cmdMongoUpdate.Flags().BoolVarP(&updateCitrixData, "updateCitrixData", "d", false, "Fetches Citrix Cloud Policy Defs and upserts to MongoDB")
